...
* [LiveWeatherPlugin](./plugins/LiveWeatherPlugin) for getting realtime weather from openweathermap.org
* [RandomWeatherPlugin](./plugins/RandomWeatherPlugin) for random weather
* [VotingWeatherPlugin](./plugins/VotingWeatherPlugin.md) for letting players vote for weather changes

### Plugin Interface

There is an experimental plugin interface for adding functionality to the server. Take a look at the [sample plugin](./plugins/SamplePlugin) to get started with developing your own plugin.

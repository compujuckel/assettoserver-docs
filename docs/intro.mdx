...
* [LiveWeatherPlugin](./plugins/LiveWeatherPlugin.mdx) for getting realtime weather from openweathermap.org
* [RandomWeatherPlugin](./plugins/RandomWeatherPlugin.mdx) for random weather
* [VotingWeatherPlugin](./plugins/VotingWeatherPlugin.mdx) for letting players vote for weather changes

### Plugin Interface

There is an experimental plugin interface for adding functionality to the server. Take a look at the [sample plugin](./plugins/SamplePlugin.mdx) to get started with developing your own plugin.
